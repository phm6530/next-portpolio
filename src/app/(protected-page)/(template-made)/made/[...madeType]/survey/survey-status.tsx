...
export default function SurveyStatus() {
  ...
  return (
    <div className="flex gap-1 md:gap-3 items-center [&>div]:flex-1 [&>div]:text-sm ">
      <div className="flex gap-2 border border-border/50 justify-center  text-center py-4 px-2 md:p-4 bg-custom-input/20 dark:bg-custom-input rounded-lg">
        총 항목 <span className="text-point">{questionsWatch.length}</span>개
      </div>

      <div className="flex gap-2 border border-border/50 justify-center text-[12px] text-center  py-4 px-2 md:p-4 bg-custom-input/20 dark:bg-custom-input rounded-lg">

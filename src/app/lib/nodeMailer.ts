...
export const sendEmail = async (
  ...
  try {
    ...
    const currentUrl = `${process.env.NEXT_PUBLIC_BASE_URL}/template/${anonymouseId}`;
    // 이메일 옵션 정의
    const mailOptions = {
      ...
      html: `
        ...
        이벤트 페이지 URL : <a href="${currentUrl}">바로가기</a><br>
        관리자 고유번호 : <span style="color :red; font-size : 14px">1111</span> <br><br><br>
